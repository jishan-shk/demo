...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <br/>
    <h5>Without Ajax</h5>
    <form name="login" action="{{route('save-demo')}}" style="background-color: gray;" method="post">
        @csrf
        <!-- Email input -->
    ...
    <form id="login_form" style="background-color: gray;">
        <!-- Email input -->
        <div class="form-outline mb-4">
